...
python main.py --dir_data ../datasets/kitti/kitti_depth --data_name KITTIDC --split_json ../data_json/kitti_dc.json \
    ...
    --loss 1.0*SeqL1+$grad_loss_weight*SeqGradL1 --intermediate_loss_weight $intermediate_loss_weight --training_depth_mask_out_rate $mask_out_rate \
    ...
    --log_dir ../experiments/ \
    --save "train_kitti_best_performance_l1" --save_full